...
public class PlayerStats
{
    ...
    public static int currPoinnts;
    public static int maxPoints;
    public static List<PlayerSkills> pskillsSta;
    #endregion
    ...
    public PlayerStats() {
        ...
        currExp = exp;
        currGold = gold;
        currSkillPoints = currPoinnts;
        maxSkillPoints = maxPoints;
        playerSkills = pskillsSta;
    }
    ...
    public void Creation(string job, string incomingName, int startHealth, int strength, int magic, Weapons starterWeapon)
    {
        ...
        level = 1;
        currPoinnts = 1;
        maxPoints = currPoinnts;
        missionList = new List<QuestData>();
        gps = "Overword";
        pskillsSta = new List<PlayerSkills>();
    }
    ...
    public int GetCurrSkillPoints() {
        return currSkillPoints;
    }
    ...
    public void LoadPlayer()
    {
        ...
        currSkillPoints = loadedPlayer.GetCurrSkillPoints();
        maxSkillPoints = loadedPlayer.GetMaxSkillPoints();
        playerSkills = loadedPlayer.GetPlayerSkills();
        ...
        currPoinnts = loadedPlayer.GetCurrSkillPoints();
        maxPoints = loadedPlayer.GetMaxSkillPoints();
        pskillsSta = loadedPlayer.GetPlayerSkills();
    ...
    public void LevelUp() {
        ...
        maxPoints++;
        currPoinnts++;
        Debug.Log("Congrats on your level up!");
    }
